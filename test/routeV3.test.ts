// import { Token, ChainId, AmplifiedWeightedPair, TokenAmount, NETWORK_CCY, WRAPPED_NETWORK_TOKENS } from '../src'
...
//     const route = new Route([pair_t0_t1], stablePool, token0)
...
//     const route = new Route([pair_s0_weth, pair_s0_s1, pair_s1_weth], stablePool, weth)
...
//     const route = new Route([pair_s0_weth, pair_t1_s0, pair_t1_t2, pair_t2_s0, pair_s0_s1, pair_s1_t0], stablePool, weth)
//     // expect(route.sources).toEqual([pair_s0_weth, pair_s0_s1, pair_s1_weth])
//     expect(route.input).toEqual(weth)
...
//     const route = new Route([pair_s0_weth], stablePool, NETWORK_CCY[chainId])
...
//     const route = new Route([pair_s0_weth], stablePool, stable0, NETWORK_CCY[chainId])
