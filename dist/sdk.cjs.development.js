...
var MINIMUM_LIQUIDITY = /*#__PURE__*/ethers.BigNumber.from(1000); // exports for internal consumption

var ZERO = /*#__PURE__*/ethers.BigNumber.from(0);
var ONE = /*#__PURE__*/ethers.BigNumber.from(1);
var TWO = /*#__PURE__*/ethers.BigNumber.from(2);
var THREE = /*#__PURE__*/ethers.BigNumber.from(3);
var FIVE = /*#__PURE__*/ethers.BigNumber.from(5);
var TEN = /*#__PURE__*/ethers.BigNumber.from(10);
var TENK = /*#__PURE__*/ethers.BigNumber.from(10000);
var _100 = /*#__PURE__*/ethers.BigNumber.from(100);
var SolidityType;
...
var SOLIDITY_TYPE_MAXIMA = (_SOLIDITY_TYPE_MAXIMA = {}, _SOLIDITY_TYPE_MAXIMA[SolidityType.uint8] = /*#__PURE__*/ethers.BigNumber.from('0xff'), _SOLIDITY_TYPE_MAXIMA[SolidityType.uint256] = /*#__PURE__*/ethers.BigNumber.from('0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff'), _SOLIDITY_TYPE_MAXIMA);
...
function validateSolidityTypeInstance(value, solidityType) {
  !value.gte(ZERO) ?  invariant(false, value + " is not a " + solidityType + ".")  : void 0;
  !value.lte(SOLIDITY_TYPE_MAXIMA[solidityType]) ?  invariant(false, value + " is not a " + solidityType + ".")  : void 0;
...
function parseBigintIsh(bigintIsh) {
  return bigintIsh instanceof ethers.BigNumber ? bigintIsh : typeof bigintIsh === 'bigint' ? ethers.BigNumber.from(bigintIsh.toString()) : ethers.BigNumber.from(bigintIsh);
...
(function (ChainId) {
  ChainId[ChainId["TT_MAINNET"] = 108] = "TT_MAINNET";
  ChainId[ChainId["TT_TESTNET"] = 18] = "TT_TESTNET";
...
var NETWORK_CCY = (_NETWORK_CCY = {}, _NETWORK_CCY[exports.ChainId.TT_MAINNET] = /*#__PURE__*/new Currency(exports.ChainId.TT_MAINNET, 18, 'TT', 'TT'), _NETWORK_CCY[exports.ChainId.TT_TESTNET] = /*#__PURE__*/new Currency(exports.ChainId.TT_TESTNET, 18, 'TT', 'TT'), _NETWORK_CCY[exports.ChainId.BSC_MAINNET] = /*#__PURE__*/new Currency(exports.ChainId.BSC_MAINNET, 18, 'BNB', 'BNB'), _NETWORK_CCY[exports.ChainId.BSC_TESTNET] = /*#__PURE__*/new Currency(exports.ChainId.BSC_TESTNET, 18, 'BNB', 'BNB'), _NETWORK_CCY[exports.ChainId.ARBITRUM_MAINNET] = /*#__PURE__*/new Currency(exports.ChainId.ARBITRUM_MAINNET, 18, 'ETH', 'ETH'), _NETWORK_CCY[exports.ChainId.ARBITRUM_TETSNET_RINKEBY] = /*#__PURE__*/new Currency(exports.ChainId.ARBITRUM_TETSNET_RINKEBY, 18, 'ETH', 'ETH'), _NETWORK_CCY[exports.ChainId.AVAX_MAINNET] = /*#__PURE__*/new Currency(exports.ChainId.AVAX_MAINNET, 18, 'AVAX', 'AVAX'), _NETWORK_CCY[exports.ChainId.AVAX_TESTNET] = /*#__PURE__*/new Currency(exports.ChainId.AVAX_TESTNET, 18, 'AVAX', 'AVAX'), _NETWORK_CCY[exports.ChainId.MATIC_MAINNET] = /*#__PURE__*/new Currency(exports.ChainId.MATIC_MAINNET, 18, 'MATIC', 'MATIC'), _NETWORK_CCY[exports.ChainId.MATIC_TESTNET] = /*#__PURE__*/new Currency(exports.ChainId.MATIC_TESTNET, 18, 'MATIC', 'MATIC'), _NETWORK_CCY[exports.ChainId.OASIS_MAINNET] = /*#__PURE__*/new Currency(exports.ChainId.OASIS_MAINNET, 18, 'ROSE', 'ROSE'), _NETWORK_CCY[exports.ChainId.OASIS_TESTNET] = /*#__PURE__*/new Currency(exports.ChainId.OASIS_TESTNET, 18, 'ROSE', 'ROSE'), _NETWORK_CCY[exports.ChainId.QUARKCHAIN_DEV_S0] = /*#__PURE__*/new Currency(exports.ChainId.QUARKCHAIN_DEV_S0, 18, 'QKC', 'QKC'), _NETWORK_CCY);
...
var TENK$1 = /*#__PURE__*/bignumber.BigNumber.from(10000);
...
function getAmountIn(amountOut, reserveIn, reserveOut, tokenWeightIn, tokenWeightOut, swapFee) {
  ...
  return signedRightShift(temp1.sub(temp2), bignumber.BigNumber.from(precision)).div(TENK$1.sub(swapFee)).add(1);
}
...
var _100$1 = /*#__PURE__*/bignumber.BigNumber.from(100);

var PAIR_ADDRESS_CACHE = {};
var PAIR_HASH = (_PAIR_HASH = {}, _PAIR_HASH[exports.ChainId.AVAX_TESTNET] = '0x9054fb12bf026c7ef2c6d1f68fbbead8f68cdbfa477faca7f9d8ec63173f87ff', _PAIR_HASH[exports.ChainId.BSC_MAINNET] = '0x623d9ad8b6787321d0dff55d4f864a7cfdedfb1802a561c75cd01c62a079bc84', _PAIR_HASH[exports.ChainId.AVAX_MAINNET] = '0x623d9ad8b6787321d0dff55d4f864a7cfdedfb1802a561c75cd01c62a079bc84', _PAIR_HASH[exports.ChainId.OASIS_MAINNET] = '0x623d9ad8b6787321d0dff55d4f864a7cfdedfb1802a561c75cd01c62a079bc84', _PAIR_HASH[exports.ChainId.OASIS_TESTNET] = '0x623d9ad8b6787321d0dff55d4f864a7cfdedfb1802a561c75cd01c62a079bc84', _PAIR_HASH[exports.ChainId.BSC_TESTNET] = '0x623d9ad8b6787321d0dff55d4f864a7cfdedfb1802a561c75cd01c62a079bc84', _PAIR_HASH[exports.ChainId.MATIC_MAINNET] = '0x623d9ad8b6787321d0dff55d4f864a7cfdedfb1802a561c75cd01c62a079bc84', _PAIR_HASH[exports.ChainId.MATIC_TESTNET] = '0x623d9ad8b6787321d0dff55d4f864a7cfdedfb1802a561c75cd01c62a079bc84', _PAIR_HASH[exports.ChainId.QUARKCHAIN_DEV_S0] = '0x623d9ad8b6787321d0dff55d4f864a7cfdedfb1802a561c75cd01c62a079bc84', _PAIR_HASH[exports.ChainId.ARBITRUM_TETSNET_RINKEBY] = '0x623d9ad8b6787321d0dff55d4f864a7cfdedfb1802a561c75cd01c62a079bc84', _PAIR_HASH[exports.ChainId.ARBITRUM_MAINNET] = '0x623d9ad8b6787321d0dff55d4f864a7cfdedfb1802a561c75cd01c62a079bc84', _PAIR_HASH);
var AmplifiedWeightedPair = /*#__PURE__*/function (_Pool) {
  ...
  AmplifiedWeightedPair.fromBigIntish = function fromBigIntish(tokens, tokenBalances, virtualReserves, weightA, fee, amp, address) {
    return new AmplifiedWeightedPair(tokens, tokenBalances.map(function (b) {
      return bignumber.BigNumber.from(b);
    }), virtualReserves.map(function (b) {
      return bignumber.BigNumber.from(b);
    }), bignumber.BigNumber.from(weightA), bignumber.BigNumber.from(fee), bignumber.BigNumber.from(amp), address);
  };
  ...
  _proto.getLiquidityValue = function getLiquidityValue(token, totalSupply, liquidity, feeOn, kLast) {
    ...
    !liquidity.raw.lte(totalSupply.raw) ?  invariant(false, 'LIQUIDITY')  : void 0;
...
var WeightedPool = /*#__PURE__*/function (_Pool) {
  ...
  provider) {
    try {
      return Promise.resolve(new contracts.Contract('0xCc62754F15f7F35E4c58Ce6aD5608fA575C5583E', new ethers.ethers.utils.Interface(weightedPoolABI), provider).calculateSwapGivenIn(inToken.address, outToken.address, inAmount));
    } catch (e) {
...
var StablePool = /*#__PURE__*/function (_Pool) {
  ...
  _proto.poolPrice = function poolPrice(tokenIn, tokenOut) {
    var virtualIn = ethers.BigNumber.from(this.tokenBalances[this.indexFromToken(tokenIn)]).div(10000);
...
var SwapData = /*#__PURE__*/function () {
  ...
  */
  ...
  SwapData.singleDataFromPool = function singleDataFromPool(tokenIn, tokenOut, pool) {
    !(pool.tokens.includes(tokenIn) && pool.tokens.includes(tokenOut)) ?  invariant(false)  : void 0;
...
var TEN$1 = /*#__PURE__*/ethers.BigNumber.from(10);
...
function markdown(pair, payoutToken) {
  ...
  return reservesOther.add(weightOther.mul(reservesOther).div(weightPayoutToken)).mul(TEN$1.pow(ethers.BigNumber.from(payoutToken.decimals)).div(getTotalValue(pair, payoutToken)));
}
...
var Route = /*#__PURE__*/function () {
  function Route(poolDict, pairData, input, output) {
    !(pairData.length > 0) ?  invariant(false, 'pairData')  : void 0;
    !(input instanceof Token && pairData[0].involvesToken(input) || input === NETWORK_CCY[pairData[0].chainId] && pairData[0].involvesToken(WRAPPED_NETWORK_TOKENS[pairData[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairData[pairData.length - 1].involvesToken(output) || output === NETWORK_CCY[pairData[0].chainId] && pairData[pairData.length - 1].involvesToken(WRAPPED_NETWORK_TOKENS[pairData[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Swap = /*#__PURE__*/function () {
  function Swap(route, amount, tradeType, poolDict) {
    ...
    if (tradeType === exports.SwapType.EXACT_INPUT) {
      ...
      var poolDictCopy = _.cloneDeep(poolDict);
      ...
      for (var i = 0; i < route.path.length - 1; i++) {
        ...
        try {
          ...
          var pool = _.cloneDeep(poolDictCopy[pair.poolRef]);
  ...
  Swap.exactIn = function exactIn(route, amountIn, poolDict) {
    return new Swap(route, amountIn, exports.SwapType.EXACT_INPUT, poolDict);
  }
  /**
  ...
  Swap.exactOut = function exactOut(route, amountOut, poolDict) {
    return new Swap(route, amountOut, exports.SwapType.EXACT_OUTPUT, poolDict);
  }
  /**
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === exports.SwapType.EXACT_OUTPUT) {
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    ...
    if (this.tradeType === exports.SwapType.EXACT_INPUT) {
...
var RouteProvider = /*#__PURE__*/function () {
  ...
  */
  ...
  lastPool, currentpools, originalCurrencyIn, bestRoutes) {
    ...
    !(pairData.length > 0) ?  invariant(false, 'PAIRS')  : void 0;
    !(maxHops > 0) ?  invariant(false, 'MAX_HOPS')  : void 0;
    !(originalCurrencyIn === tokenIn || currentpools.length > 0) ?  invariant(false, 'INVALID_RECURSION')  : void 0;
...
exports.pairDataFromPools = pairDataFromPools;
