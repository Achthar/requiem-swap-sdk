...
var WeightedPair = /*#__PURE__*/function () {
  ...
  WeightedPair.getAddress = function getAddress(tokenA, tokenB, weightA, fee) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE$1) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$t = _PAIR_ADDRESS_CACHE[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE$t === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$t[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE$1 = _extends({}, PAIR_ADDRESS_CACHE$1, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE$1) === null || _PAIR_ADDRESS_CACHE2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE2[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = address.getCreate2Address(WEIGHTED_FACTORY_ADDRESS[tokens[0].chainId], solidity.keccak256(['bytes'], [solidity.pack(['address', 'address', 'uint32', 'uint32'], [tokens[0].address, tokens[1].address, weightA.toString(), fee.toString()])]), INIT_CODE_HASH_WEIGHTED[tokens[0].chainId]), _extends2)), _extends3));
    }
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    ...
    JSBI.BigInt(getAmountOut(inputAmount.toBigNumber(), inputReserve.toBigNumber(), outputReserve.toBigNumber(), bignumber.BigNumber.from(inputWeight.toString()), bignumber.BigNumber.from(outputWeight.toString()), bignumber.BigNumber.from(this.fee.toString())).toString()));
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    JSBI.BigInt(getAmountIn(outputAmount.toBigNumber(), inputReserve.toBigNumber(), outputReserve.toBigNumber(), bignumber.BigNumber.from(inputWeight.toString()), bignumber.BigNumber.from(outputWeight.toString()), bignumber.BigNumber.from(this.fee.toString())).toString()));
